...
import { parentCostCenterFields } from '../config/appConfig';
import GenericDataScreen from './GenericDataScreen';

export default function ParentCostCenterScreen() {
    const BASE_RESOURCE = 'employees/parentCostCenter';
    
    const EMPLOYER_ID = 'CLIENT-005';

    const moduleConfig = {
      title: 'Parent Cost Center',
      fields: parentCostCenterFields,
      primaryField: 'parentCostCenterType',
      statusField: 'status',
